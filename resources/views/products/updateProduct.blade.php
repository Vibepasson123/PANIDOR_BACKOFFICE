            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/updateProduct" method="POST">
                        ...
                        swal("", "PRODUCT UPDATED SUCESSFULLY", "success");
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label class="bmd-label-floating"></label>
                                    <input type="text" value="{{$pro->discription}}" name="discription" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <p>Cod Artigo</p>
                                <div class="form-group">
                                    <label class="bmd-label-floating"></label>
                                    <input type="text" value="{{$pro->codArtigo}}" name="codArtigo" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label class="bmd-label-floating">{{$pro->short_description}}</label>
                                    <input type="text" value="{{$pro->short_description}}" name="short" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <p>PRICE</p>
                                <div class="form-group">
                                    <label class="bmd-label-floating">{{$pro->price}}</label>
                        ...
                        <button type="submit" value="{{$call_id}}" name="id" class="btn btn-primary pull-right">UPDATE
                            PRODUCT</button>
                ...
                <div class="clearfix">
                    ...
                    <form method="post" action="{{url('productpic_upload')}}" enctype="multipart/form-data">
               ...
               <div class="form-group" style=" padding-top: 90px;" id="">
                   ...
                   <div class="input-group">
                       <span class="input-group-btn">
                            <input type="file" name="image" id="imgInp" style="visibility:hidden">
                           <span class="btn btn-primary pull-left btn-file">
                               SELECT PICTURE 
                           </span>
                       </span>
                       <input type="text" class="form-control img_name" id ="file_name_path" readonly>
                       <button class="btn btn-success pull-right " name="product" type="submit" value="{{$call_id}}" id="upload">
                           UPLOAD
                       </button>
                   </div>
               </div>
                         ...
                         <div class="row">
                             <div class="col-sm-12">
                                 <table id="datatab2"  class="table table-striped table-no-bordered ">
                                     ...
                                     <tbody>
                                     @foreach ($product_image as $image_items)
                                         ...
                                         <td>   <a  class="btn btn-link btn-danger btn-just-icon edit" id="deleteImage" data-id="{{$image_items->id}}" data-file_id="{{$image_items->file_id}}" ><i
                                             class="material-icons" title="Delete Image">delete</i></a>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#imgInp").change(function () {
            $("#file_name_path").val($(this).val().replace(/C:\\fakepath\\/i, ''));
            //readURL(this);
        });
